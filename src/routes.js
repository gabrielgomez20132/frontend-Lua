...
const AllPersonTutor = React.lazy(() => import('./views/notas/AllNotes'))
//const login2 = React.lazy(() => import('./views/components/login/login'))
...
const routes = [
  ...
  { path: '/personas', name: 'Personas', component: AllPersonTutor, exact: true },
  //{ path: '/login2', name: 'login', component: login2 },
]
